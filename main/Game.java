...
public class Game {
    ...
    public static void gameWin() {
        try{
            ...
            Main.setMediaPlayer(null);  // 清空旧的播放器
            ...
            Media media = new Media(Main.class.getResource("/resources/Music/WinMusic.mp3").toString());
            MediaPlayer mediaPlayer = new MediaPlayer(media);
            Main.setMediaPlayer(mediaPlayer);
    ...
    public static void gameLose() {
        try{
            ...
            Main.getMainWindow().setScene(Main.getMainMenuScene());
            Media media = new Media(Main.class.getResource("/resources/Music/losemusic2.mp3").toString());
            MediaPlayer mediaPlayer = new MediaPlayer(media);
            Main.setMediaPlayer(mediaPlayer);
            Main.getMediaPlayer().play();
