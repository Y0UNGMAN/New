...
public class Stage {
    ...
    public static void initializeStage1() {
        stageZombie = new double[][]{
                {8, NORMAL_ZOMBIE},{25, NORMAL_ZOMBIE},{35, NORMAL_ZOMBIE},{46, NORMAL_ZOMBIE},
                {53, CONEHEAD_ZOMBIE},{62, NORMAL_ZOMBIE},{78, FLAG_ZOMBIE},{80, NORMAL_ZOMBIE},
    ...
    public static void initializeStage2() {
        stageZombie = new double[][]{
                {8, NORMAL_ZOMBIE},{19,NORMAL_ZOMBIE},{25, NORMAL_ZOMBIE},{30, NORMAL_ZOMBIE},{47, BUCKETHEAD_ZOMBIE},{55, NORMAL_ZOMBIE},{57, CONEHEAD_ZOMBIE},
    ...
    public static void initializeStage3() {
        stageZombie = new double[][]{
                {8, NORMAL_ZOMBIE},{21,NEWSPAPER_ZOMBIE},{27, NORMAL_ZOMBIE},{39, CONEHEAD_ZOMBIE},{45, NORMAL_ZOMBIE},{55, NORMAL_ZOMBIE},
    ...
    public static void initializeStage4() {
        stageZombie = new double[][]{
                {8, NORMAL_ZOMBIE},{25,CONEHEAD_ZOMBIE},{40, NORMAL_ZOMBIE},{52, CONEHEAD_ZOMBIE},{60, NORMAL_ZOMBIE},{67, NORMAL_ZOMBIE},
                {78, NORMAL_ZOMBIE},{85, NORMAL_ZOMBIE},{90, NEWSPAPER_ZOMBIE},{75, NORMAL_ZOMBIE},{85, NORMAL_ZOMBIE},{87, FLAG_ZOMBIE},{88, NORMAL_ZOMBIE},
    ...
    public static void initializeStage5() {
        stageZombie = new double[][]{
                {8,BUCKETHEAD_ZOMBIE},{10, NORMAL_ZOMBIE},{35, NEWSPAPER_ZOMBIE},{55, CONEHEAD_ZOMBIE},{60, BUCKETHEAD_ZOMBIE}
        };
    }
}
