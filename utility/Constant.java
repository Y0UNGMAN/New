...
public class Constant {
     ...
     */
    public static final double NORMAL_ZOMBIE_MOVEMENT_SPEED = -6;    //-16.67
     ...
     */
    public static final double CONEHEAD_ZOMBIE_MOVEMENT_SPEED = -6;
     ...
     */
    public static final double BUCKETHEAD_ZOMBIE_MOVEMENT_SPEED = -6;
     ...
     */
    public static final double FLAG_ZOMBIE_MOVEMENT_SPEED = -6;
     ...
     */
    public static final double NEWSPAPER_ZOMBIE_MOVEMENT_SPEED = -6;
    /**
     * 读报僵尸（Newspaper Zombie）失去报纸后的移速
     */
    public static final double NEWSPAPER_ZOMBIE_RAGE_MOVEMENT_SPEED = -16.67; // after losing newspaper
     ...
     * 豌豆射手（Peashooter）的攻速
     */
    public static final double PEASHOOTER_ATTACK_SPEED = 1.75;
    /**
     ...
     * 雪花射手（Snow Pea）的攻速
     */
    public static final double SNOW_PEA_ATTACK_SPEED = 1.75;
    /**
     ...
     * 双枪豌豆（Repeater）的攻速
     */
    public static final double REPEATER_ATTACK_SPEED = 1.75;
    /**
    ...
    /**
     * <p>
     *    没有选择购买新植物以及选择使用铲子的情况下，此方法将被调用，用来判定是否选择购买了新植物或点击了铲子。
     * </p>
     * <p>
     *     点击购买了新植物或使用了铲子，则会把对应植物或铲子的图片显示出来，并且这个图片跟着鼠标的移动而移动。
     *     什么都没选择，或是点击了非法区域，则此方法什么都不做。
     * </p>
     * @param tileNumber 玩家鼠标点击的坐标对应的格子编号
     * @param x 鼠标点击的位置的x轴坐标
     * @param y 鼠标点击的位置的y轴坐标
     */
